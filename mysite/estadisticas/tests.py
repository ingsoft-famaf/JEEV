...
class EstadisticasTest(TestCase):
    ...
    def setUp(self):
        ...
        examen1 = Exam.objects.create(nombre_materia='Lengua', nombre_tema='Lectura', cantidad_preg=3,
                                      tiempo_preg=14, preguntas_correctas=2, preguntas_incorrectas=1)
        examen2 = Exam.objects.create(nombre_materia='Lengua', nombre_tema='Escritura', cantidad_preg=6,
                                      tiempo_preg=14, preguntas_correctas=4, preguntas_incorrectas=2)
        examen3 = Exam.objects.create(nombre_materia='Algebra', nombre_tema='Matrices', cantidad_preg=5,
